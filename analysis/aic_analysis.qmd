...
processed |>
  ...
  gtsave(filename = paste0("tables/demographic", ".tex"))
```
...
processed |> 
  ...
  gtsave(filename = paste0("tables/chatgpt_use", ".tex"))
```
...
processed |>
  ...
  gt() |> 
  gtsave(filename = paste0("tables/ai_main", ".tex"))
```
...
processed |>
  ...
  outcome_var_rename(items) |> 
  gt() |> 
  gtsave(filename = paste0("tables/responsibility_main", ".tex"))
```
...
processed |>
  ...
  outcome_var_rename(items) |> 
  gt() |> 
  gtsave(filename = paste0("tables/gender_main", ".tex"))
```
...
processed |>
  ...
  outcome_var_rename(items) |> 
  gt() |> 
  gtsave(filename = paste0("tables/mother_main", ".tex"))
```
...
processed |>
  ...
  outcome_var_rename(items) |> 
  gt() |> 
  gtsave(filename = paste0("tables/father_main", ".tex"))
```
...
`Top 30%`,
  ...
  outcome_var_rename(items) |> 
  gt() |> 
  gtsave(filename = paste0("tables/economic_main", ".tex"))
```
